...
function maxNumberOnes(arr) {

}

// http://www.geeksforgeeks.org/print-unique-rows/
function printUniqueRows(arr) {
...
function printMatrixDiagonally(arr) {

}

// http://www.geeksforgeeks.org/strassens-matrix-multiplication/
function strassensMatrixMultiplication(arr) {
